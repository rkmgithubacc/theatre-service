# Getting Started
This is a Spring Boot microservice to manage theatre related events/ activities for the movie booking application (mba). This will demonstrate below:
...
5. Spring Validation
6. Movie service will synchronously communicate with Theatre service
